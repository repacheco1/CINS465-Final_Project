...
urlpatterns = [
    ...
    path('chat/', views.chatPageView, name='chat'),
    path('chat/<str:room_name>/', views.chatRoomPageView, name='room'),
    path('users/', views.ProfileList.as_view(), name='profile'),
    path('user/<slug:slug>/', views.ProfileDetails.as_view(), name='profile_details'),
    # path('user/<int:pk>/', views.ProfileDetail.as_view(), name='profile_details_pk'),
    ...
    path('blog/<slug:slug>/', views.blogDetailsPageView, name='blog_details'),
